## Introduction au CI/CD, MONITORING et OBSERVABILITE

### Introduction

Dans ce tutoriel, nous allons voir comment utiliser les outils de CI/CD, de MONITORING et d'OBSERVABILITE pour améliorer la qualité de notre code.

### Objectifs
- Découvrir les outils de CI/CD, de MONITORING et d'OBSERVABILITY
